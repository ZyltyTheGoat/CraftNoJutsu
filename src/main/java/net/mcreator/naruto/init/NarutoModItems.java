...
import net.mcreator.naruto.item.ScrollTransformationItem;
import net.mcreator.naruto.item.ScrollSubstitutionItem;
import net.mcreator.naruto.item.ScrollShadowImitationItem;
import net.mcreator.naruto.item.ScrollShadowCloneItem;
...
import net.mcreator.naruto.item.ScrollMultiSizeItem;
import net.mcreator.naruto.item.ScrollMindBodyTransferItem;
...
import net.mcreator.naruto.item.ScrollGenjutsuItem;
import net.mcreator.naruto.item.ScrollFourSymbolSealItem;
import net.mcreator.naruto.item.ScrollFlyingRaijinItem;
...
import net.mcreator.naruto.item.ScrollBodyFlickerItem;
...
public class NarutoModItems {
	...
	public static final DeferredItem<Item> SCROLL_SHADOW_CLONE = REGISTRY.register("scroll_shadow_clone", ScrollShadowCloneItem::new);
	public static final DeferredItem<Item> SCROLL_TRANSFORMATION = REGISTRY.register("scroll_transformation", ScrollTransformationItem::new);
	public static final DeferredItem<Item> SCROLL_SUBSTITUTION = REGISTRY.register("scroll_substitution", ScrollSubstitutionItem::new);
	public static final DeferredItem<Item> SCROLL_BODY_FLICKER = REGISTRY.register("scroll_body_flicker", ScrollBodyFlickerItem::new);
	public static final DeferredItem<Item> SCROLL_FLYING_RAIJIN = REGISTRY.register("scroll_flying_raijin", ScrollFlyingRaijinItem::new);
	public static final DeferredItem<Item> SCROLL_GENJUTSU = REGISTRY.register("scroll_genjutsu", ScrollGenjutsuItem::new);
	public static final DeferredItem<Item> SCROLL_MIND_BODY_TRANSFER = REGISTRY.register("scroll_mind_body_transfer", ScrollMindBodyTransferItem::new);
	public static final DeferredItem<Item> SCROLL_SHADOW_IMITATION = REGISTRY.register("scroll_shadow_imitation", ScrollShadowImitationItem::new);
	public static final DeferredItem<Item> SCROLL_MULTI_SIZE = REGISTRY.register("scroll_multi_size", ScrollMultiSizeItem::new);
	public static final DeferredItem<Item> SCROLL_FOUR_SYMBOL_SEAL = REGISTRY.register("scroll_four_symbol_seal", ScrollFourSymbolSealItem::new);

...
public class PhoenixFlowerRenderer extends EntityRenderer<PhoenixFlowerEntity> {
	...
	public PhoenixFlowerRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelProjectile(context.bakeLayer(ModelProjectile.LAYER_LOCATION));
	}

	@Override
	public void render(PhoenixFlowerEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(PhoenixFlowerEntity entity) {
		return texture;
	}
}